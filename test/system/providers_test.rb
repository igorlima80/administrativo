...
class ProvidersTest < ApplicationSystemTestCase
  ...
  test "creating a Provider" do
    ...
    fill_in "Cpf", with: @provider.cpf
    fill_in "Email", with: @provider.email
    fill_in "Name", with: @provider.name
    fill_in "Nickname", with: @provider.nickname
    fill_in "Principal Seller", with: @provider.principal_seller
    fill_in "Register", with: @provider.register
