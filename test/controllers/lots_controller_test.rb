...
class LotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lot" do
    assert_difference('Lot.count') do
      post lots_url, params: { lot: { product_id: @lot.product_id, quantity: @lot.quantity, unit_id: @lot.unit_id, unit_value: @lot.unit_value } }
    end
  ...
  test "should update lot" do
    patch lot_url(@lot), params: { lot: { product_id: @lot.product_id, quantity: @lot.quantity, unit_id: @lot.unit_id, unit_value: @lot.unit_value } }
