...
class QuotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post quotations_url, params: { quotation: { provider_id: @quotation.provider_id, register: @quotation.register } }
    end
  ...
  test "should update quotation" do
    patch quotation_url(@quotation), params: { quotation: { provider_id: @quotation.provider_id, register: @quotation.register } }
